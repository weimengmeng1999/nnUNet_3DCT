...
# from nnunetv2.training.nnUNetTrainer.variants.multi_task.positional_encoding import PositionalEncoding3D, PositionalEncodingPermute3D
...
class nnUNetTrainer_CLSHeadMA(nnUNetTrainer):
    def __init__(self, plans: dict, configuration: str, fold: int, dataset_json: dict,
        ...
        '/home/mengwei/Downloads/nnUNet_code/pretrain/checkpoint_best.pth')
    ...
    def build_cls_head(self):
        cls_head = Classifier3D(in_channels_list=[128, 320, 320, 128],
        H=5, W=8, D=5,
        d=320,
        N=200,
        num_layers=4,
    ...
    def configure_optimizers_cls(self):
        # RAdam optimizer, same LR for all params
        optimizer = RAdam([
        {'params': self.network.parameters(), 'lr': self.initial_lr},
        {'params': self.cls_head.parameters(), 'lr': self.initial_lr},
        ], weight_decay=self.weight_decay)

        # Cosine LR decay from initial_lr -> 0 over num_epochs
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        with autocast(self.device.type, enabled=True):
            ...
            # with mask guided pooling - ver12
