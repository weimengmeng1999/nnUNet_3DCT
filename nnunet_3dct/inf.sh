...
export nnUNet_results="/nfs/home/mwei/nnUNet_results/nnUNet_results_final"
...
python nnunetv2/inference/predict_classification_fast_CLSHeadSum.py \
  -i /nfs/home/mwei/nnUNet_3d_data/nnUNet_raw/Dataset001_3DCT/imagesVal \
  -o /nfs/home/mwei/nnUNet_results/nnUNet_results_final/segreTr_fast \
  -co /nfs/home/mwei/nnUNet_results/nnUNet_results_final/segreTr_fast \
  -d Dataset001_3DCT \
  -c 3d_fullres \
  -tr nnUNetTrainer_CLSHeadSumFT\
  -p nnUNetPlans \
  -f 0 \
  -chk checkpoint_best_stage2.pth \
  --save_probabilities
